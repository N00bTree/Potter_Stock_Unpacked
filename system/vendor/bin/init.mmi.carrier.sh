...
android_go=`getprop ro.mot.android_go`
    ...
    case $carrier in
        ...
        * )
            case $wave in
                2017.[3-4]|201[8-9].[1-4] )
                    setprop ro.com.google.clientidbase.am android-motorola
                    if [ "$android_go" == "true" ]; then
                        setprop ro.com.google.clientidbase.ms android-motorola-rev1
                    else
                        setprop ro.com.google.clientidbase.ms android-motorola-rev2
                    fi
                ;;
        ...
        usc )
            ...
            case $wave in
                ...
                201[8-9].[1-4] )
                    ...
                    setprop ro.telephony.default_network 8,0
                ;;
            esac
        ;;
        bouyfr )
